...
import { updateProfile, uploadImage } from "../api/LinkStackApi";
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-2">
        ...
        <input
          ...
          {...register("handle", {
            required: "The handle is mandatory and cannot be empty",
          })}
        />
      ...
      <div className="grid grid-cols-1 gap-2">
        ...
        <textarea
          ...
          {...register("description", {
            required: "The description is mandatory and cannot be empty",
          })}
        />
